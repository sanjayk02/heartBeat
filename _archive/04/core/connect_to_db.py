...
# Heart Beat Application - MongoDB Connection Module
# This module provides a class to connect to a MongoDB database, load configuration
# from a YAML file, and perform basic database operations such as inserting logs and
# summaries, and fetching logs and summaries.
# =============================================================================
# Imports
# =============================================================================
# Standard Libraries
...
_get_config = os.path.join(_root, "config/config.yaml").replace("\\", "/")
...
class MongoDatabase:
    ...
    # ------------------------------------------------------------------------
    # __enter__ and __exit__ methods for context manager support
    # ------------------------------------------------------------------------
    def __enter__(self):
