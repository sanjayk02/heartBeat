...
SETTINGS_FILE   = os.path.join(_root, "config/config.yaml").replace("\\", "/")
...
class IdleReporter:
    ...
    def load_settings(self):
        ...
        try:
            ...
            logging.error(f"Failed to load settings idle_reporter.py: {e}")
            self.settings = default_settings
    ...
    def monitor(self):
        ...
        idle_threshold = self.settings.get("idle_threshold", 300)
